let btnNext = document.querySelector("#start");
console.log("btnnext" + btnNext);
var panel = document.querySelector('#quiz-area');
...
function start() {
    ...
    document.querySelector('#subwrapper').prepend('<h2>Time Remaining: <span id="counter-number">60</span> Seconds</h2>');
